...
class MemoFormVC: UIViewController {
    ...
    @IBAction func save(_ sender: Any) {
        ...
        //조건을 만족하지 않으면 종료 : 이럴때 사용하는 게 guard
        //조건에 맞는 경우와 그렇지 않은 경우에 다른 처리를 하려고 할때는 : if를 쓴다.
        
        //contents에 내용이 없으면 리턴이 된다.
        ...
        //데이터 저장 - 이 작업 후에 memo 데이터를 // Core Data 나 Server에 저장하고 다시 출력
